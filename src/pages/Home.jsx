    ...
    <div>
      ...
      <div className='bg-pure-greys-5 text-richblack-700'>
        ...
        <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
          ...
          <div className='flex xs:flex-col md:flex-row lg:flex-row gap-5 mb-10 mt-[95px]'>
            <div className='text-4xl font-semibold md:w-[45%] lg:w-[45%]'>
              Get the Skills you need for a
              <HighlightText text={"Job that is in demand"} />
            </div>

            <div className='flex flex-col gap-10 md:w-[40%] lg:w-[40%] items-start'>
      ...
      <div className='w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 first-letter bg-richblue-500 text-white'>
        ...
        <h2 className='text-center text-4xl font-bold mt-10' style={gradientStyle}>Review from Other Learners</h2>
        {/* Review Slider here */}
        <ReviewSlider />
      </div>
